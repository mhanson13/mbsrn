...
def _render_managed_deploy_workflow_yaml(
    *,
    ...
    workflow_yaml_unsigned = (
        ...
        "              static_ip_metadata_eval=\"$(printf '%s' \"$static_ip_metadata_json\" | python - <<'PY'\n"
        "          import json\n"
        "          import sys\n"
        "\n"
        ...
        "              cert_collect_output=\"$(printf '%s' \"$managed_certificate_json\" | EXPECTED_PREVIEW_HOST=\"$preview_host\" EXPECTED_CERT_NAME=\"$expected_cert_name_collect\" python - <<'PY'\n"
        "          import json\n"
        "          import os\n"
        "          import sys\n"
        "\n"
        ...
        "            printf '%s' \"$managed_certificate_payload\" | EXPECTED_PREVIEW_HOST=\"$preview_host\" EXPECTED_CERT_NAME=\"$expected_cert_name\" python - <<'PY'\n"
        "          import json\n"
        "          import os\n"
        "          import sys\n"
        "\n"
        ...
        "            echo \"observed_managed_certificate_status=$tls_certificate_status\"\n"
        "            echo \"observed_managed_certificate_domain_status=$tls_domain_status\"\n"
        "          }\n"
