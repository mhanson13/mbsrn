...
def test_runtime_git_credentials_are_read_from_environment(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setenv("ENVIRONMENT", "development")
    monkeypatch.setenv("APP_ENV", "ci")
    monkeypatch.setenv("DATABASE_URL", "postgresql+psycopg://postgres:postgres@localhost:5432/mbsrn")
    monkeypatch.setenv("GIT_USERID", "mhanson13")
    monkeypatch.setenv("GIT_EMAIL", "mhanson13@gmail.com")
    monkeypatch.setenv("GIT_TOKEN", "test-token-value")
