...
describe("admin route", () => {
  ...
  it("renders wrapped admin sections and places Admin Console above Principals", async () => {
    mockUseAuth.mockReturnValue({
      principal: {
        business_id: "biz-1",
    ...
    expect(headings.indexOf("Admin Console")).toBeGreaterThanOrEqual(0);
    expect(headings.indexOf("Principals and Identities")).toBeGreaterThanOrEqual(0);
    expect(headings.indexOf("Admin Console")).toBeLessThan(headings.indexOf("Principals and Identities"));
  });
