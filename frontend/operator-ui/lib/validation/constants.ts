...
export const COMPETITOR_TIMEOUT_SECONDS_MIN = 10;
export const COMPETITOR_TIMEOUT_SECONDS_MAX = 90;
export const DEFAULT_COMPETITOR_TIMEOUT_SECONDS = 30;
export const MIGRATION_DRAFT_TIMEOUT_SECONDS_MIN = 30;
export const MIGRATION_DRAFT_TIMEOUT_SECONDS_MAX = 900;
export const DEFAULT_MIGRATION_DRAFT_TIMEOUT_SECONDS = 120;
