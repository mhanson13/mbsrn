      ...
      <section className="legal-page">
        ...
        <div className="legal-sections">
          <article className="legal-section">
            ...
            <p>
              By accessing or using MBSRN, you agree to these terms. If you do not agree, do not use
              the service.
            </p>
          </article>
          ...
          <article className="legal-section">
            ...
            <p>
              MBSRN is an operator-focused SEO platform for audits, recommendations, competitor
              context, and workflow visibility. It is intended to support decision-making and execution
          ...
          <article className="legal-section">
            ...
            <p>
              Some features use third-party services (including Google APIs) when configured. You must
              have rights and authority to connect those accounts and properties.
            </p>
          </article>
          ...
          <article className="legal-section">
            ...
            <p>
              We may modify, suspend, or improve features as needed for security, reliability, and
              product evolution.
            </p>
          </article>
          ...
          <article className="legal-section">
            ...
            <p>
              ...
              allowed by law. MBSRN does not guarantee specific SEO rankings, traffic increases, or
              business outcomes.
            </p>
          </article>
          ...
          <article className="legal-section">
            ...
            <p>
              To the maximum extent permitted by law, MBSRN will not be liable for indirect,
          ...
          <article className="legal-section">
            ...
            <p>
              If you use a paid plan, billing cadence, renewal, and cancellation terms are provided at
              the time of purchase and in your plan documentation. If no paid plan applies, available
              free or trial access is still governed by these terms.
            </p>
          </article>
          ...
          <article className="legal-section">
            ...
            <p>
              We may suspend or terminate access for material violations of these terms. You may stop
          ...
          <article className="legal-section">
            ...
            <p>
              We may revise these terms from time to time. Updated versions will be posted on this page
